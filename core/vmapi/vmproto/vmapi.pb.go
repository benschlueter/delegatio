...
type ExecCommandResponse struct {
	...
	//	*ExecCommandResponse_Output
	//	*ExecCommandResponse_Log
	Content isExecCommandResponse_Content `protobuf_oneof:"content"`
}
...
func (m *ExecCommandResponse) GetContent() isExecCommandResponse_Content {
	if m != nil {
		return m.Content
	}
	return nil
...
func (x *ExecCommandResponse) GetOutput() []byte {
	if x, ok := x.GetContent().(*ExecCommandResponse_Output); ok {
		return x.Output
	}
	return nil
}

func (x *ExecCommandResponse) GetLog() *Log {
	if x, ok := x.GetContent().(*ExecCommandResponse_Log); ok {
		return x.Log
	}
	return nil
}

type isExecCommandResponse_Content interface {
	isExecCommandResponse_Content()
}

type ExecCommandResponse_Output struct {
	Output []byte `protobuf:"bytes,1,opt,name=output,proto3,oneof"`
}

type ExecCommandResponse_Log struct {
	Log *Log `protobuf:"bytes,2,opt,name=log,proto3,oneof"`
}

func (*ExecCommandResponse_Output) isExecCommandResponse_Content() {}

func (*ExecCommandResponse_Log) isExecCommandResponse_Content() {}
...
var file_vmapi_proto_rawDesc = []byte{
	...
	0x6d, 0x61, 0x70, 0x69, 0x22, 0x42, 0x0a, 0x12, 0x45, 0x78, 0x65, 0x63, 0x43, 0x6f, 0x6d, 0x6d,
	...
	,
	...
	0x64, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x2f, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x76,
	0x6d, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x6d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_vmapi_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_vmapi_proto_goTypes = []interface{}{
	(*ExecCommandRequest)(nil),  // 0: vmapi.ExecCommandRequest
	(*ExecCommandResponse)(nil), // 1: vmapi.ExecCommandResponse
	(*Log)(nil),                 // 2: vmapi.Log
}
var file_vmapi_proto_depIdxs = []int32{
	2, // 0: vmapi.ExecCommandResponse.log:type_name -> vmapi.Log
	0, // 1: vmapi.API.ExecCommand:input_type -> vmapi.ExecCommandRequest
	1, // 2: vmapi.API.ExecCommand:output_type -> vmapi.ExecCommandResponse
...
func file_vmapi_proto_init() {
	...
	file_vmapi_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*ExecCommandResponse_Output)(nil),
		(*ExecCommandResponse_Log)(nil),
	}
	type x struct{}

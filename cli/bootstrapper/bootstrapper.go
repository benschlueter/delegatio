...
func NewKubernetes(log *zap.Logger, loadbalancerIP string, k8sConfig []byte) (Bootstrapper, error) {
	instance, err := kubernetes.NewBootstrapper(log, loadbalancerIP, k8sConfig)
	if err != nil {
		return nil, err
	}
	return instance, nil
